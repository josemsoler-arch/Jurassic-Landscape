  ...
  return (
    <section className="min-h-screen flex flex-col justify-end px-12 pb-20 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        >
          Landscape Design &amp; Installation · Est. 2019
        </div>

        <a
          href="mailto:jurassiclandscapedesign@gmail.com"
          className="text-xs tracking-wide inline-block mb-3"
          style={{
          ...
          onMouseLeave={(e) => (e.target.style.color = "rgba(240,234,216,0.5)")}
        >
        ...
        >
          JURASSIC
          <br />
          <span style={{ color: "var(--leaf)" }}>LANDSCAPE</span>
        ...
        <div
          ...
          style={{ animation: "fadeUp 0.8s forwards 0.9s", opacity: 0 }}
        >
      ...
      <div
        ...
        style={{ animation: "fadeIn 1s forwards 1.2s", opacity: 0 }}
      >
        {[
